        ...
        <div id="tier1-nav">
          <div class="row">
            <div class="large-9 large-push-3 medium-10 medium-push-2 small-10 small-push-2 columns">
              <div class="row">
                <div class="large-5 medium-7 small-12 columns"><h1><a href="index.html"><span class="first-word">EMU</span> Today</a></h1></div>
          ...
          <div class="large-10 large-push-2 medium-10 medium-push-2 small-10 small-push-2 columns">
            <div class="row">
              <div class="large-12 medium-12 small-12 columns">
                <ul>
                  <li><a class="right-arrow" href="index.html">Today</a></li>
                  <li><a href="calendar/index.html">Calendar</a></li>
                  <li><a href="announcements/index.html">Announcements</a></li>
                  <li><a href="news/index.html">News</a></li>
                  <li><a href="student-profiles/index.html">Student Profiles</a></li>
                  <li><a href="http://www.emueagles.com/index.aspx">Athletics</a></li>
                </ul>
              </div>
            </div>
          </div>
          <div class="large-2 large-pull-10 medium-2 medium-pull-10 small-2 small-pull-10 columns">&nbsp;
          </div>
        </div>
      </div>
  ...
  <div id="content-area">
    ...
    <div id="four-stories-bar">
      <div id="news-title-bar" class="row">
        <div class="large-12 medium-12 small-12 columns manageleftpadding"><h5 class="subhead-title">Featured News Stories</h5></div>
      </div>
      <div class="row" >
          ...
          <li>
            ...
            <div class="stories-content">
              <div class="stories-text-content" data-equalizer-watch>
                <p>On the Run: EMU student overcomes obstacles in life, in school & during marathons</p>
              </div>
              <p class="button-group"><a href="news/story.html" class="button">Read more <img class="news-icon" src="images/readmore-arrow.png" alt="Read more button"></a></p>
            </div>
          </li>
          <li>
            ...
            <div class="stories-content">
              ...
              <p class="button-group"><a href="#" class="button">More Info <img class="news-icon" src="images/readmore-arrow.png" alt="Read more button"></a></p>
            </div>
          </li>
          <li>
            ...
            <div class="stories-content">
              ...
              <p class="button-group"><a href="#" class="button">Read more <img class="news-icon" src="images/readmore-arrow.png" alt="Read more button"></a></p>
            </div>
          </li>
          <li>
    ...
    <div id="base-bar">
      <div class="row">
        <div id="university-contacts" class="large-2 medium-2 hide-for-small columns noleftpadding">
          <a href="http://www.emich.edu"><img class="bottom-logo" alt="Eastern Michigan University" src="images/logo.png"/></a>
        </div>
        <div id="linking-lists" class="large-7 medium-10 small-12 columns noleftpadding">
          ...
          <p><a href="">Non-Discrimination Statement</a> | <a href="">Privacy Policy | Copyright 2015</a></p>
        </div>
        <div id="social-links" class="large-3 medium-12 small-12 columns noleftpadding norightpadding">
          <ul class="social-icons">
            <li><a href="https://www.facebook.com/Eastern.Michigan.University"><img alt="Facebook" src="images/icons/facebook-base-icons.png"></a></li>
            <li><a href="http://www.emich.edu/twitter/"><img alt="Twitter" src="images/icons/twitter-base-icons.png"></a></li>
            <li><a href="https://www.youtube.com/user/emichigan08"><img alt="YouTube" src="images/icons/you-tube-base-icons.png"></a></li>
            <li><a href="https://instagram.com/easternmichigan/"><img alt="Instagram" src="images/icons/instagram-base-icons.png"></a></li>
            <li><a href="https://www.linkedin.com/edu/school?id=18604"><img alt="Linked-In" src="images/icons/linked-in-base-icons.png"></a></li>
            <li><a href="http://blogemu.com/"><img alt="Blog EMU" src="images/icons/e-base-icons.png"></a></li>
          </ul>
        </div>
      </div>
